...
public enum PanelPosition: Sendable, Equatable {
    ...
    /// Centers the window both horizontally and vertically on the screen.
    case center
    
    /// Centers the window horizontally, aligned to the top of the screen with a vertical offset.
    /// - Parameter offset: The distance in points from the top edge of the screen to the top of the window.
    case top(offset: CGFloat)
    
    /// Centers the window horizontally, aligned to the bottom of the screen with a vertical offset.
    /// - Parameter offset: The distance in points from the bottom edge of the screen to the bottom of the window.
    case bottom(offset: CGFloat)
    
    /// Positions the window at a specific coordinate in screen space.
